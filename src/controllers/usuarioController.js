...
function cadastrar(req, res) {
    ...
    if (nome == undefined) {
        ...
        usuarioModel.cadastrar(nome, email, senha, cep, estado)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
...
function ver_votos_zoro(req, res) {
    usuarioModel.ver_votos_zoro()
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json(resultado);
            } else {
...
function ver_votos_nami(req, res) {
    usuarioModel.ver_votos_nami()
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json(resultado);
            } else {
...
function ver_votos_usopp(req, res) {
    usuarioModel.ver_votos_usopp()
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json(resultado);
            } else {
...
function ver_votos_sanji(req, res) {
    usuarioModel.ver_votos_sanji()
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json(resultado);
            } else {
...
function ver_votos_chopper(req, res) {
    usuarioModel.ver_votos_chopper()
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json(resultado);
            } else {
...
function ver_votos_robin(req, res) {
    usuarioModel.ver_votos_robin()
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json(resultado);
            } else {
...
function ver_votos_franky(req, res) {
    usuarioModel.ver_votos_franky()
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json(resultado);
            } else {
...
function ver_votos_brook(req, res) {
    usuarioModel.ver_votos_brook()
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json(resultado);
            } else {
...
function ver_votos_jinbe(req, res) {
    usuarioModel.ver_votos_jinbe()
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json(resultado);
            } else {
